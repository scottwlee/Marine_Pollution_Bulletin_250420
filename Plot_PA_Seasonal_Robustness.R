# Visualization of Seasonal Robustness Curves for Particle-Attached (PA) Bacterial Networks
...
data <- read.csv("PA_Robustness_Data.csv")
...
p <- p + labs(
  ...
  title = 'Seasonal robustness curves of PA bacterial community networks'
) +
  ylim(0, 1)
...
# 5. Save Plot to File
######################################################
ggsave("PA_Robustness_Curve.tiff", pa_robustness, dpi = 300, width = 24, height = 20, units = "cm")
